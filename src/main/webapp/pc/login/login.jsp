...
<body>
		...
		<form id="fm" class="layui-form" style="margin-bottom: 26px;" action="/admin/main">
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
					<input type="text" id="name" lay-verify="title" autocomplete="off" placeholder="请输入学号" onkeydown="if(event.keyCode==13) go_login()" class="layui-input">
				</div>
			</div>
			<div class="layui-form-item">
	...
	<div style="text-align: center; font-size: 13px; color: #525252; padding-top: 30px; ">@2017-客户管理系统</div>
